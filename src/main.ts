...
class ExampleMod extends OMod {
  ...
  static version: string = "0.0.3 Alpha";
  ...
  static init(): void {
    ...
    // DEV NOTE: OEntities are not yet completed in OvenMDK, this is just a example.
    const coolEntity_main_sound =
